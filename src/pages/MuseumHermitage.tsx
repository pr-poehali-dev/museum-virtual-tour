...
const MuseumHermitage = () => {
  ...
  const artworks = [
    ...
    },
    {
      ...
      year: "1490-1491",
      description:
        "Одна из самых известных работ великого мастера Возрождения, изображающая Мадонну с младенцем.",
      image:
        "https://images.unsplash.com/photo-1578321272176-b7bbc0679853?w=800&h=600&fit=crop",
      audioText:
        "Леонардо да Винчи создал это произведение в период расцвета своего таланта. Картина демонстрирует идеальную гармонию композиции и нежность материнской любви.",
      duration: "4:20",
    },
  ];
