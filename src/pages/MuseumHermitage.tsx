...
const MuseumHermitage = () => {
  ...
  const artworks = [
    ...
    {
      id: 3,
      title: "Павлин и девушка",
      artist: "Василий Поленов",
      year: "1871",
      description:
        "Романтическая картина русского художника, воплощающая идеалы красоты XIX века.",
      image:
        "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop",
      audioText:
        "Поленов мастерски сочетает восточную экзотику с классическими традициями европейской живописи.",
      duration: "2:45",
    },
  ];
